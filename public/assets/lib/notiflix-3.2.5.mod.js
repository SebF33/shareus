...
* Modifié par Sébastien Flouriot le 26/11/2022 pour fonctionner avec le thème de Bootswatch
*/
...
(function (root, factory) {
  ...
  var notifySettings = {
    ...
    distance: '10px',
    opacity: 1,
    borderRadius: '255px 25px 225px 25px/25px 225px 25px 255px', // Modif
    rtl: false,
    timeout: 3000,
